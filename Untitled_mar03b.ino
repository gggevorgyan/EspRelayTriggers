...
///////////////////////// --- VENTILATION --- ////////////////////////////
  SwitchRelays ventilationSwitch("vent", VENTILATION_START_OUT_PIN,
                                    VENTILATION_STOP_OUT_PIN,
                                    &ventilation_switch,
                                    VENTILATION_STATUS_IN_PIN, &preferences );

///////////////////////// --- IRRIGATION --- /////////////////////////////  
  SwitchRelays irrigationSwitch("irrg", IRRIGATION_START_OUT_PIN,
                                  IRRIGATION_STOP_OUT_PIN,
                                  &irrigation_switch,
                                  IRRIGATION_STATUS_IN_PIN, &preferences );

/////////////////////////// --- WINDOW --- ////////////////////////////////  
  Slider3Relays window("window",
                        WINDOW_UP_OUT_PIN,
                        WINDOW_DOWN_OUT_PIN,
                        WINDOW_STOP_OUT_PIN,
                        &windowSlider,
...
void setup() {
  ...
  //ventilationSwitch.initStatus();
  //irrigationSwitch.initStatus();
  window.initStatus();
